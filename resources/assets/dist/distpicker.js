  ...
  var Distpicker = function () {
    ...
    _createClass(Distpicker, [{
      ...
      value: function init() {
        ...
        $.each([PROVINCE, CITY, DISTRICT,TOWN,VILLAGE], function (i, type) {
          if (data[type]) {
      ...
      value: function bind() {
        ...
        if (this.$district) {
          this.$district.on(EVENT_CHANGE, this.onChangeDistrict = $.proxy(function () {
              _this2.output(TOWN);
              // _this2.output(VILLAGE);
          }, this));
        }
       ...
       if (this.$town) {
          this.$town.on(EVENT_CHANGE, this.onChangeTown = $.proxy(function () {
              _this2.output(VILLAGE);
          }, this));
       }
      }
      ...
      value: function unbind() {
        ...
        if (this.$district) {
          this.$district.off(EVENT_CHANGE, this.onChangeDistrict);
        }

        if (this.$town) {
          this.$town.off(EVENT_CHANGE, this.onChangeTown);
        }
      }
    }, {
      key: 'output',
      value: function output(type) {
        ...
        switch (type) {
          ...
          case TOWN:
            ...
            var districts = this.getAjaxTown(code);
            break;
          case VILLAGE:
            code = this.$town && (this.$town.find(':selected').data('code') || '');
            var districts = this.getAjaxVillage(code);
            break;
        }
      ...
      key: 'getAjaxTown',
      value: function getAjaxTown() {
        var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CODE;
          var dataJson = null;
          $.ajax({
              type:'get',
              url: '/api/v1/admin_api/town_area',
              data: {'q':code},
              dataType: 'json',
              async: false,
        ...
        key: 'getAjaxVillage',
        value: function getAjaxVillage() {
            var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CODE;
            var dataJson = null;
            $.ajax({
                type:'get',
                url: '/api/v1/admin_api/village_area',
                data: {'q':code},
                dataType: 'json',
                async: false,
                success: function (res) {
